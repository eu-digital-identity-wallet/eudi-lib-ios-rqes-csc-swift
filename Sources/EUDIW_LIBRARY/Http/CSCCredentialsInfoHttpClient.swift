...
internal final actor CSCCredentialsInfoClient {

    internal static func makeRequest(for request: CSCCredentialsInfoRequest, accessToken: String, oauth2BaseUrl:String) async throws -> CSCCredentialsInfoResponse {
