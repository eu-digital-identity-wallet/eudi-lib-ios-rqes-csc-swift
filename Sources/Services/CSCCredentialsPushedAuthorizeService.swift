...
final actor CSCCredentialsPushedAuthorizeService: CSCCredentialsPushedAuthorizeServiceType {

    init() {}

    func pushedAuthorize(
        ...
        try CSCCredentialsPushedAuthorizeValidator.validate(request)
