...
final actor CSCCredentialsAuthorizeClient {

    static func makeRequest(for request: CSCCredentialsAuthorizeRequest, accessToken: String, oauth2BaseUrl:String) async throws -> CSCCredentialsAuthorizeResponse {
